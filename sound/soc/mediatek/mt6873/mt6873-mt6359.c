...
static int mt6873_mt6359_dev_probe(struct platform_device *pdev)
{
	...
	for (i = 0; i < card->num_links; i++) {
		if (mt6873_mt6359_dai_links[i].codec_name ||
			...
			continue;
	//prize added by huarui, aw881xx stereo support, 20190111-start
		if (mt6873_mt6359_dai_links[i].num_codecs > 1)
			continue;
	//prize added by huarui, aw881xx stereo support, 20190111-end
