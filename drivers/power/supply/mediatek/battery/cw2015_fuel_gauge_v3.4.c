...
static int cw_get_capacity(struct cw_battery *cw_bat)
{
	...
	*/
	...
	/* case 1 : aviod swing */
	/*UI_SOC = ((real_SOC * 256 + digit_SOC) * 100) / (100 * 256);
	...
	pr_err("gezi-----cw2015 dump info real_SOC = %d,digit_SOC = %d,cw_capacity=%d,cw_bat->capacity=%d,remainder=%d,UI_SOC=%d\n", \
			real_SOC,digit_SOC,cw_capacity,cw_bat->capacity,remainder,UI_SOC);
...
//prize add by lipengpeng 20190919 start
		//cw_capacity=0;//fucehou keep 1% charge status
