...
static void fts_fwupg_work(struct work_struct *work)
{
    ...
    if (ret < 0) {
		...
		//strcpy(current_tp_info.chip,"Focaltech_FW:0x01");
		sprintf(current_tp_info.id,"0x%04x",chip_id_info);
