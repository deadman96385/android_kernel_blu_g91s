...
struct stCAM_CAL_LIST_STRUCT g_camCalList[] = {
	...
	// prize add by zhuzhengjiang for OTP 20210301 start
	{S5K3L6_SENSOR_ID, 0xA0, Common_read_region},
	// prize add by zhuzhengjiang for OTP 20210301 end
	// prize add by linchong for OTP 20210629 start
	{S5KGM1ST_SENSOR_ID, 0xB0, Common_read_region},
	{GC08A3SUB_SENSOR_ID, 0xB4, Common_read_region},
	// prize add by linchong for OTP 20210629 end
