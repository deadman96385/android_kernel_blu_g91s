...
/*prize add by zhuzhengjiang 20201212 start*/
UINT32 S5KGM1ST_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 S5KGM1STGMS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
/*prize add by zhuzhengjiang 20201212 end*/
...
UINT32 IMX351_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc); //dtw
...
UINT32 S5K2P7SQ_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 S5K3P9TWO_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 S5K3P3SXGQ_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 GC80342LANEMIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
//przie--huangjiwu ---20201130--start
UINT32 OV5695_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OS12D40_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//przie--huangjiwu ---20201130--end
